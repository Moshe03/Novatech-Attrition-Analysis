...
**Role:** Data Analyst — data cleaning, modelling, dashboard design, and insight
...
Employees in their earliest tenure band showed the highest exit rate, and analyst-level attrition was the highest of any job level. This reframes the problem from "retain everyone" to "fix the first year, especially in customer-facing roles."

**4. Engagement predicts exits — and the flag is usefully sharp.**
Leavers scored markedly lower on engagement (**2.98** vs **3.53** for stayers). A flight-risk flag I built captured this: employees flagged high-risk left at a **36.4% rate, nearly double the 19.1% company average**, making it a practical early-warning signal for managers.
